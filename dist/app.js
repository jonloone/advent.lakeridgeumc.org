...
_gsap.TweenMax.to(".star__logo", 1, { width: "8rem", transform: "translateY(4vh)", delay: 2, ease: _gsap.Expo.easeIn });

_gsap.TweenMax.to(".star__burst", .85, { opacity: "1", delay: 2.5, ease: _gsap.Expo.easeIn });
_gsap.TweenMax.to(".ground--back", 1, { fill: "#272067", delay: 2, ease: _gsap.Expo.easeIn });
_gsap.TweenMax.to(".ground--middle", 1, { fill: "#1E1759", delay: 2, ease: _gsap.Expo.easeIn });
_gsap.TweenMax.to(".home", .85, { backgroundColor: "#1A144F", delay: 2.5, ease: _gsap.Expo.easeIn });

_gsap.TweenMax.to(".banner__wordmark", .5, { transform: "translateY(0vh)", opacity: "0", delay: 2, ease: _gsap.Expo.easeIn });
_gsap.TweenMax.to(".stars", .75, { opacity: "1", delay: 2.5, ease: _gsap.Expo.easeIn });
